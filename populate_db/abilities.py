...
academics = Ability.objects.get_or_create(name="Academics", property_name="academics")[
    0
]
acrobatics = Ability.objects.get_or_create(
    name="Acrobatics", property_name="acrobatics"
)[0]
alertness = Ability.objects.get_or_create(name="Alertness", property_name="alertness")[
    0
]
...
athletics = Ability.objects.get_or_create(name="Athletics", property_name="athletics")[
    0
]
awareness = Ability.objects.get_or_create(name="Awareness", property_name="awareness")[
    0
]
...
carousing = Ability.objects.get_or_create(name="Carousing", property_name="carousing")[
    0
]
...
cosmology = Ability.objects.get_or_create(name="Cosmology", property_name="cosmology")[
    0
]
...
diplomacy = Ability.objects.get_or_create(name="Diplomacy", property_name="diplomacy")[
    0
]
...
etiquette = Ability.objects.get_or_create(name="Etiquette", property_name="etiquette")[
    0
]
expression = Ability.objects.get_or_create(
    name="Expression", property_name="expression"
)[0]
fast_draw = Ability.objects.get_or_create(name="Fast Draw", property_name="fast_draw")[
    0
]
fast_talk = Ability.objects.get_or_create(name="Fast Talk", property_name="fast_talk")[
    0
]
...
hypnotism = Ability.objects.get_or_create(name="Hypnotism", property_name="hypnotism")[
    0
]
...
intuition = Ability.objects.get_or_create(name="Intuition", property_name="intuition")[
    0
]
...
seduction = Ability.objects.get_or_create(name="Seduction", property_name="seduction")[
    0
]
